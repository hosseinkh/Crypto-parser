...
from utiles.snapshot import (
    SnapshotParams, build_snapshot_v41, DEFAULT_TFS
)
from utiles.trending import (
    scan_trending, explain_trending_row, TrendScanParams
)
...
default_list = st.sidebar.text_area(
    "Favorites (comma separated, /USDT)",
...
candles_limit = st.number_input(
    "Candles limit (per TF)", value=240, min_value=100, max_value=2000, step=10
)
