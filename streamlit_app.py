...
default_list = st.sidebar.text_area(
    ...
    "BTC/USDT,ETH/USDT,BNB/USDT,SOL/USDT,ADA/USDT,TRX/USDT,LINK/USDT,DOT/USDT,LTC/USDT,XRP/USDT, XTZ/USDT, PENGU/USDT, CTO/USDT
    ,"INJ/USDT", "GRT/USDT", "AVAX/USDT", "FET/USDT", "ADA/USDT","XRP/USDT")
